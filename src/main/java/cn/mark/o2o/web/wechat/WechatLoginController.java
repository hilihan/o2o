 ...
 * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx80eb08d264849b01&redirect_uri=http://lihan.free.ngrok.cc/o2o/wechatlogin/logincheck&role_type=1&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect
...
public class WechatLoginController {
	...
	public String doGet(HttpServletRequest request,HttpServletResponse response) {
		...
		//这个state可以用来传输我们自定义的信息，方便程序调用，这里也可以不用
